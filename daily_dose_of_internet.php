...
<div class="channel-banner" style="background: linear-gradient(135deg, #331a0d, #703020);"></div>

<div class="channel-header-wrap">
    <img src="images/img6.png" alt="Daily Dose of Internet" class="channel-avatar-lg">
    <div class="channel-meta">
        <h1 class="channel-name">Daily Dose of Internet <i class="fa-solid fa-circle-check" style="font-size:18px;color:#3ea6ff"></i></h1>
        <p class="channel-stats">17,8 mln subskrybentów • 0 filmów</p>
        <p class="channel-desc">Codziennie najciekawsze klipy z całego internetu — śmieszne, niesamowite i zaskakujące.</p>
    </div>
